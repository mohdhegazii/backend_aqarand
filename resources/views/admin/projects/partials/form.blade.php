        ...
        <div x-show="currentStep === 1" x-cloak class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="name_ar" value="{{ old('name_ar', $project->name_ar ?? '') }}" class="w-full rounded border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
                    <label class="block text-gray-700 font-bold mb-2">{{ __('admin.project_name_en') }} <span class="text-red-500">*</span></label>
                    <input type="text" name="name_en" value="{{ old('name_en', $project->name_en ?? '') }}" class="w-full rounded border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
            ...
            <div class="bg-gray-50 p-4 rounded border border-gray-200">
                ...
                <div x-show="showCascading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4 transition-all duration-300">
                    <div>
                        ...
                        <select name="country_id" x-model="selectedCountry" @change="fetchRegions()" class="w-full rounded border-gray-300 p-2 text-sm">
                    ...
                    <div>
                        ...
                        <select name="region_id" x-model="selectedRegion" @change="fetchCities()" class="w-full rounded border-gray-300 p-2 text-sm">
                    ...
                    <div>
                        ...
                        <select name="city_id" x-model="selectedCity" @change="fetchDistricts()" class="w-full rounded border-gray-300 p-2 text-sm">
