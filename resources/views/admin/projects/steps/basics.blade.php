    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function populateSelect(select, items) {
                ...
                items.forEach(item => {
                    ...
                    if(item.lat !== null && item.lat !== undefined && item.lng !== null && item.lng !== undefined) {
                        // Ensure we store as dot-decimal string even if API returned mixed types
            ...
            initLocationMap({
                ...
                lat: {{ number_format($project->lat ?? 26.8206, 7, '.', '') }}, // Default to Egypt center
