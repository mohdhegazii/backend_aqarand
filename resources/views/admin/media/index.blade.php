    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-4" role="alert">
                <p class="font-bold">@lang('admin.legacy_view')</p>
                <p>
                    @lang('admin.legacy_view_desc')
                    <a href="{{ route($adminRoutePrefix.'media-manager.index') }}" class="underline text-yellow-800 font-bold hover:text-yellow-900">@lang('admin.go_to_media_manager')</a>.
                </p>
            </div>
