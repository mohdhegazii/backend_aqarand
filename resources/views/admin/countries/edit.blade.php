...
@section('header', __('admin.edit') . ' ' . __('admin.countries'))

@section('content')
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <form action="{{ route($adminRoutePrefix.'countries.update', $country) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="is_active" class="form-checkbox text-blue-500" value="1" {{ $country->is_active ? 'checked' : '' }}>
