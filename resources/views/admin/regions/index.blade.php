...
@section('content')
    <div class="mb-4 flex flex-col md:flex-row justify-between space-y-4 md:space-y-0">
        ...
        <form action="{{ route('admin.regions.index') }}" method="GET" class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 rtl:md:space-x-reverse">
            <select name="country_id" class="border rounded px-4 py-2">
