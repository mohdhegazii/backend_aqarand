            ...
            <form action="{{ route('admin.districts.update', $district) }}" method="POST">
                ...
                <div class="mb-4 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="lat" value="{{ old('lat', $district->lat) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="e.g. 30.0444">
                    </div>
                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">@lang('admin.lng')</label>
                        <input type="text" name="lng" value="{{ old('lng', $district->lng) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="e.g. 31.2357">
                    </div>
                </div>
