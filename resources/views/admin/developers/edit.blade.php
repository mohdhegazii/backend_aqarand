...
@section('content')
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <form action="{{ route('admin.developers.update', ['locale' => $locale, 'developer' => $developer]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mt-6 border-t pt-6">
                    ...
                    <div class="flex items-center justify-end space-x-4 rtl:space-x-reverse">
                        <a href="{{ route('admin.developers.index', ['locale' => $locale]) }}" class="text-gray-600 hover:text-gray-900">
                            @lang('admin.cancel')
                        </a>
