                    ...
                    <div class="mb-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                @php
                                    // Try to resolve media link for 'logo'
                                    $logoMediaId = null;
                                    // Check if HasMedia trait and relation exists
                                    if(method_exists($developer, 'mediaLinks')) {
                                         $logoMediaId = $developer->mediaLinks()->where('role', 'logo')->first()?->media_file_id;
                                    }
                                @endphp
                                <x-admin.media-picker
                                    name="logo_media_id"
                                    :value="old('logo_media_id', $logoMediaId)"
                                    :multiple="false"
                                />
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const handleLogoChange = (event) => {
                ...
                if (!file) {
                    // resetLogoPreview(); // Don't reset main preview if we have media
                    return;
                }
