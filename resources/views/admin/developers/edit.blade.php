            ...
            <form action="{{ route('admin.developers.update', $developer) }}" method="POST" enctype="multipart/form-data">
                ...
                <div id="myTabContent">
                    ...
                    <div class="hidden p-4 rounded-lg bg-gray-50" id="en" role="tabpanel" aria-labelledby="en-tab">
                        ...
                        @include('admin.partials.seo_meta_box', ['locale' => 'en', 'seoMeta' => $developer->seoMeta ?? new \App\Models\SeoMeta()])
                    </div>
                    ...
                    <div class="hidden p-4 rounded-lg bg-gray-50" id="ar" role="tabpanel" aria-labelledby="ar-tab">
                        ...
                        @include('admin.partials.seo_meta_box', ['locale' => 'ar', 'seoMeta' => $developer->seoMeta ?? new \App\Models\SeoMeta()])
                    </div>
                </div>
