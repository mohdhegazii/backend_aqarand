                ...
                <div id="myTabContent">
                    ...
                    <div class="p-4 rounded-lg bg-gray-50" id="en" role="tabpanel" aria-labelledby="en-tab">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name_en" value="{{ old('name_en') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                        <div class="mb-4">
                        ...
                        @include('admin.partials.seo_meta_box', ['model' => new \App\Models\Developer(), 'locale' => 'en'])
                    </div>
                    ...
                    <div class="hidden p-4 rounded-lg bg-gray-50" id="ar" role="tabpanel" aria-labelledby="ar-tab">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name_ar" value="{{ old('name_ar') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-right" dir="rtl">
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">@lang('admin.description_ar')</label>
                            <textarea name="description_ar" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline font-mono text-sm text-right" rows="6" dir="rtl">{{ old('description_ar') }}</textarea>
                        </div>
                        @include('admin.partials.seo_meta_box', ['model' => new \App\Models\Developer(), 'locale' => 'ar'])
                    </div>
                </div>
